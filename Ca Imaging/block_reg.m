...
rootdir = 'C:\Users\supersub\Desktop\Sample stack to register\to process';
cd(rootdir);
xpix = 512;
ypix = 512;
...
Images_Ch1 = dir(['*.tif']); % get all file names of block image stacks
Images_Ch2 = dir(['Stack.tif']); % get all file names of block image stacks

for block = 1:length(Images_Ch2)
    [blockdat_Ch1] = loadtif(Images_Ch1(1).name, rootdir);
